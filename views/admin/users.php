<section class="admin-users">
    ...
    <p class="text-muted" style="margin:0 0 12px 0;font-size:13px;">
        🕐 Looking for staff time-in / time-out? It moved to
        <a href="<?= BASE_URL ?>/reports/timein">Reports → Staff Time-In</a>.
        Time-out is now recorded automatically when staff log out.
    </p>
